...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 08, 2024 at 08:30 AM
...
--
-- Table structure for table `auth_service_customuser`
--

CREATE TABLE `auth_service_customuser` (
  `id` bigint(20) NOT NULL,
...
--
-- Table structure for table `auth_service_customuser_groups`
--

CREATE TABLE `auth_service_customuser_groups` (
  `id` bigint(20) NOT NULL,
...
--
-- Table structure for table `auth_service_customuser_user_permissions`
--

CREATE TABLE `auth_service_customuser_user_permissions` (
  `id` bigint(20) NOT NULL,
  `customuser_id` bigint(20) NOT NULL,
  `permission_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `department` (`DepartmentID`, `Name`, `Description`, `Icon`, `ParentID`) VALUES
(7, 'Cashier', 'Cashier Department', '⭐', NULL),
(8, 'Warehouse', 'Warehouse Department', '📋', NULL),
(9, 'Accounting', 'Accounting Department', '💼', NULL),
(10, 'Management', 'Management Department', '👤', NULL),
(11, 'Service', 'Service Department', '🍴', NULL),
(12, 'IT', 'Information Technology Department', '💻', NULL),
(13, 'Kitchen', 'Kitchen Department', '🍳', NULL);
...
(1, 'contenttypes', '0001_initial', '2024-11-06 16:10:06.848232'),
(2, 'contenttypes', '0002_remove_content_type_name', '2024-11-06 16:10:06.883357'),
(3, 'auth', '0001_initial', '2024-11-06 16:10:06.974318'),
(4, 'auth', '0002_alter_permission_name_max_length', '2024-11-06 16:10:06.991174'),
(5, 'auth', '0003_alter_user_email_max_length', '2024-11-06 16:10:06.995315'),
(6, 'auth', '0004_alter_user_username_opts', '2024-11-06 16:10:07.000054'),
(7, 'auth', '0005_alter_user_last_login_null', '2024-11-06 16:10:07.006495'),
(8, 'auth', '0006_require_contenttypes_0002', '2024-11-06 16:10:07.008725'),
(9, 'auth', '0007_alter_validators_add_error_messages', '2024-11-06 16:10:07.014101'),
(10, 'auth', '0008_alter_user_username_max_length', '2024-11-06 16:10:07.019412'),
(11, 'auth', '0009_alter_user_last_name_max_length', '2024-11-06 16:10:07.026241'),
(12, 'auth', '0010_alter_group_name_max_length', '2024-11-06 16:10:07.039122'),
(13, 'auth', '0011_update_proxy_permissions', '2024-11-06 16:10:07.065490'),
(14, 'auth', '0012_alter_user_first_name_max_length', '2024-11-06 16:10:07.070182'),
(15, 'auth_service', '0001_initial', '2024-11-06 16:10:07.172547'),
(16, 'admin', '0001_initial', '2024-11-06 16:10:07.213204'),
(17, 'admin', '0002_logentry_remove_auto_add', '2024-11-06 16:10:07.219456'),
(18, 'admin', '0003_logentry_add_action_flag_choices', '2024-11-06 16:10:07.228549'),
(19, 'sessions', '0001_initial', '2024-11-06 16:10:07.249409'),
(20, 'authtoken', '0001_initial', '2024-11-06 18:38:06.470069'),
(21, 'authtoken', '0002_auto_20160226_1747', '2024-11-06 18:38:06.488407'),
(22, 'authtoken', '0003_tokenproxy', '2024-11-06 18:38:06.491238'),
(23, 'authtoken', '0004_alter_tokenproxy_options', '2024-11-06 18:38:06.495682');
...
('0xx5j1nx4ml509s36pd5eiwu519l477g', 'eyJ1c2VybmFtZSI6ImxhbSJ9:1t8liK:odtIbbdJL9iND7nyqsY4Zm8gM_iVFIdxMAXV0yYPVrA', '2024-11-20 19:29:12.337068'),
('9jfl9rz7c6gpksqgyem7too21iyuz59r', 'eyJ1c2VybmFtZSI6ImxhbSJ9:1t8loO:izm3YEBghnVQYnVaGxTCYUd8Ts6VisGQK25Pb8_JqgU', '2024-11-20 19:35:28.906776'),
('9xw3frsz2j7swwbwm0ew6af5ngguan0g', 'eyJ1c2VybmFtZSI6ImxhbSIsInN0YWZmX2lkIjoxLCJyb2xlX2lkIjoxLCJmaXJzdFBhZ2UiOiJhZG1pbiJ9:1t8mJ8:wmcjHWSV-8dUDN1208z6ZTi1-hWezPdOnrf4_9zLnsk', '2024-11-20 20:07:14.503853'),
('ghfe10zl0342obaqiuvoshwcna23q4xg', 'eyJ1c2VybmFtZSI6ImxhbSIsInN0YWZmX2lkIjoxLCJyb2xlX2lkIjoxLCJmaXJzdFBhZ2UiOiJhZG1pbiJ9:1t8rKE:AzCLVhzJO1EcMiuLdFnn1fHX826o0b4aDbAaqKneVTU', '2024-11-21 01:28:42.841092'),
('riod8wqnkaa828e42lzf230uj9itndyb', 'eyJ1c2VybmFtZSI6ImxhbSIsInN0YWZmX2lkIjoxLCJyb2xlX2lkIjoxfQ:1t8m9B:zzZ-ft5ZLsR4_vpYaEKR4i6plJ03f8cjLqIhHxZZtqc', '2024-11-20 19:56:57.925367');
...
INSERT INTO `role` (`RoleID`, `Name`, `Description`, `DepartmentID`, `FirstPage`) VALUES
(1, 'Admin', 'Admin of system', NULL, 'admin'),
...
(1, 'lam', '0932536334', 4, '123', 1, NULL, 'lam'),
...
(4, 'Michael Brown', '0932363243', 3, 'password123', 0, '2024-10-18 22:39:24', 'michael_brown'),
(6, 'David Wilso', '0932536332', 5, 'password123', 1, '2024-10-18 22:39:24', 'david_wilson'),
...
(10, 'Thomas Hall', '', 9, '123', 1, '2024-10-18 22:39:24', 'thomas_hall');
...
--
-- Indexes for table `auth_service_customuser`
--
ALTER TABLE `auth_service_customuser`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `username` (`username`);

--
-- Indexes for table `auth_service_customuser_groups`
--
ALTER TABLE `auth_service_customuser_groups`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `auth_service_customuser__customuser_id_group_id_b8b8747c_uniq` (`customuser_id`,`group_id`),
  ADD KEY `auth_service_customu_group_id_beba85e9_fk_auth_grou` (`group_id`);

--
-- Indexes for table `auth_service_customuser_user_permissions`
--
ALTER TABLE `auth_service_customuser_user_permissions`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `auth_service_customuser__customuser_id_permission_fc54a7f4_uniq` (`customuser_id`,`permission_id`),
  ADD KEY `auth_service_customu_permission_id_05b1f476_fk_auth_perm` (`permission_id`);
...
ALTER TABLE `department`
  ...
  ADD KEY `fk_department_parent` (`ParentID`);
...
ALTER TABLE `django_admin_log`
  ...
  ADD KEY `django_admin_log_user_id_c564eba6_fk_auth_service_customuser_id` (`user_id`);
...
--
-- AUTO_INCREMENT for table `auth_service_customuser`
--
ALTER TABLE `auth_service_customuser`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `auth_service_customuser_groups`
--
ALTER TABLE `auth_service_customuser_groups`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `auth_service_customuser_user_permissions`
--
ALTER TABLE `auth_service_customuser_user_permissions`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `authtoken_token`
  ADD CONSTRAINT `authtoken_token_user_id_35299eff_fk_auth_service_customuser_id` FOREIGN KEY (`user_id`) REFERENCES `auth_service_customuser` (`id`);
...
--
-- Constraints for table `auth_service_customuser_groups`
--
ALTER TABLE `auth_service_customuser_groups`
  ADD CONSTRAINT `auth_service_customu_customuser_id_d9bf1ac4_fk_auth_serv` FOREIGN KEY (`customuser_id`) REFERENCES `auth_service_customuser` (`id`),
  ADD CONSTRAINT `auth_service_customu_group_id_beba85e9_fk_auth_grou` FOREIGN KEY (`group_id`) REFERENCES `auth_group` (`id`);

--
-- Constraints for table `auth_service_customuser_user_permissions`
--
ALTER TABLE `auth_service_customuser_user_permissions`
  ADD CONSTRAINT `auth_service_customu_customuser_id_32500d8b_fk_auth_serv` FOREIGN KEY (`customuser_id`) REFERENCES `auth_service_customuser` (`id`),
  ADD CONSTRAINT `auth_service_customu_permission_id_05b1f476_fk_auth_perm` FOREIGN KEY (`permission_id`) REFERENCES `auth_permission` (`id`);
...
--
ALTER TABLE `department`
  ADD CONSTRAINT `fk_department_parent` FOREIGN KEY (`ParentID`) REFERENCES `department` (`DepartmentID`) ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE `django_admin_log`
  ...
  ADD CONSTRAINT `django_admin_log_user_id_c564eba6_fk_auth_service_customuser_id` FOREIGN KEY (`user_id`) REFERENCES `auth_service_customuser` (`id`);
