...
urlpatterns = [
    ...
    path('reserve/<int:table_id>/', views.reserve_table_online, name='reserve_table_online'),
    path('cancel/<int:table_id>/', views.cancel_reservation, name='cancel_reservation'),
    path('update-status/<int:table_id>/<str:status>/', views.update_table_status, name='update_table_status'),
