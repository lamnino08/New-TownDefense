...
def view_all_tables(request):
    ...
    return render(request, 'table_service/table/view_table_status.html', {'tables': tables})
...
def order_food(request, table_id):
    ...
    return render(request, 'table_service/dish/order_dish.html')
...
def view_orders(request, table_id):
    ...
    return render(request, 'table_service/kitchen/orders.html', {'orders': orders})
