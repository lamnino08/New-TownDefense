...
def book_table(request):
    if request.method == 'POST':
        ...
        if table:
            ...
            # Lưu thông tin đặt bàn, sử dụng các model hoặc cấu trúc bạn đã định nghĩa
            # Thêm logic lưu thông tin đặt bàn vào database
            messages.success(request, f"Bàn {table.name} đã được đặt thành công bởi {
